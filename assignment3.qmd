...
-   Dissimilarity:
    ...
    "Votes" and "cast" are frequently appeared in the website of Grand Boulevard is that this community is politically active, which supported the Democratic Party.

    “University” is included in top words as University of Chicago is located in Hyde Park. Hyde Park is near Lake Michigan and Kenwood, so that's why "Lake" and "Kenwood" also shown in the top words.

    For Kenwood, it is a community which near Hyde Park, so "Hyde" and "Park" are both included in the common words in the description of Kenwood. Moreover, there are many schools in Kenwood community.

    Oakland is near Lake Michigan, so "Lake" is listed in the top words in Oakland. There are many African-Americans settled in Oakland, and that's why "African" is mentioned frequently in the description of Oakland. There are many houses in Oakland due to the increase of immigrants, so "House" and "Homes" are common in descriptions.
